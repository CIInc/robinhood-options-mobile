...
class TradeStrategyDefaults {
  static final List<TradeStrategyTemplate> defaultTemplates = [
    TradeStrategyTemplate(
      id: 'default_all_indicators_high_conviction',
      name: 'All Indicators (85% Strength)',
      description:
          'Utilizes all available technical indicators with a high entry threshold (85% Signal Strength), allowing for broad consensus without requiring unanimity.',
      config: TradeStrategyConfig(
        ...
        indicatorReasons: {
          ...
          'marketDirection': 'Market trend direction.',
          'volume': 'Volume confirmation.',
          'macd': 'Trend following momentum.',
          'bollingerBands': 'Volatility and price level analysis.',
          'stochastic': 'Momentum oscillator.',
          'atr': 'Volatility measurement.',
          'obv': 'Volume flow analysis.',
          'vwap': 'Volume weighted average price.',
          'adx': 'Trend strength.',
          'williamsR': 'Momentum oscillator.',
          'ichimoku': 'Trend and support/resistance.',
          'cci': 'Cyclical trend analysis.',
          'parabolicSar': 'Trend following and reversals.',
    ...
    TradeStrategyTemplate(
      id: 'default_trend_pullback_sma200',
      name: 'Trend Pullback (SMA 200)',
      description:
          'Buy dips in an established uptrend. Enters when Price is above SMA 200 but RSI is low (< 45).',
      config: TradeStrategyConfig(
        minSignalStrength: 60.0,
        requireAllIndicatorsGreen: false,
        startDate: DateTime.now().subtract(const Duration(days: 365)),
        ...
        indicatorReasons: {
          'priceMovement': 'Ensures price action remains constructive.',
          'momentum': 'RSI < 45 identifies the pullback opportunity.',
          'atr': 'Used for volatility-adjusted stop loss placement.',
        },
        customIndicators: [
          CustomIndicatorConfig(
    ...
    TradeStrategyTemplate(
      id: 'default_golden_cross_approx',
      name: 'Golden Cross Trend',
      description:
          'Classic long-term trend following. Buys when Price is above both SMA 50 and SMA 200 with strong trend strength.',
      config: TradeStrategyConfig(
        minSignalStrength: 70.0,
        requireAllIndicatorsGreen: false,
        startDate:
        ...
        indicatorReasons: {
          'marketDirection': 'Approximates Golden Cross conditions.',
          'adx': 'ADX > 20 confirms the trend is strengthening.',
          'volume': 'Volume expansion validates the new trend.',
        },
        customIndicators: [
          CustomIndicatorConfig(
