...
class TradeStrategyDefaults {
  static final List<TradeStrategyTemplate> defaultTemplates = [
    ...
    TradeStrategyTemplate(
      id: 'default_gex_pinning_mean_reversion',
      name: 'GEX Mean Reversion',
      description:
          'Exploits "Pinning" regimes. Buys when dealer GEX is strongly positive (gamma-long), indicating a mean-reverting market where volatility is suppressed.',
      config: TradeStrategyConfig(
        minSignalStrength: 75.0,
        requireAllIndicatorsGreen: false,
        startDate: DateTime.now().subtract(const Duration(days: 365)),
        ...
        indicatorReasons: {
          'gammaExposure': 'Positive GEX creates a price magnet effect.',
          'bollingerBands': 'Mean reversion from the bands.',
          'stochastic': 'Oversold entry in a range-bound regime.',
        },
        takeProfitPercent: 5.0,
        stopLossPercent: 3.0,
        riskPerTrade: 0.015,
        enableDynamicPositionSizing: true,
        gexExitEnabled: true,
        gexExitThreshold: 0.0, // Exit if GEX turns negative
      ),
      createdAt: DateTime.now(),
    ),
    TradeStrategyTemplate(
      id: 'default_gex_volatility_acceleration',
      name: 'GEX Trend Accelerator',
      description:
          'Rides the "Trend" regimes. Buys during high-conviction momentum when GEX turns strongly negative (gamma-short), indicating a regime where market makers must hedge in the direction of the move.',
      config: TradeStrategyConfig(
        ...
        indicatorReasons: {
          'gammaExposure': 'Negative GEX amplifies the prevailing trend.',
          'macd': 'Confirms strong directional momentum.',
          'adx': 'Confirms trend strength is expanding.',
        },
        takeProfitPercent: 12.0,
        stopLossPercent: 6.0,
        trailingStopEnabled: true,
    ...
    TradeStrategyTemplate(
      id: 'default_gex_intraday_scalp',
      name: 'GEX Intraday Scalp',
      description:
          'Fast-paced scalping strategy using 15-minute intervals. Buys when GEX magnitude is high and aligning with VWAP and RSI momentum for quick mean-reversion or breakout moves.',
      config: TradeStrategyConfig(
        minSignalStrength: 70.0,
        requireAllIndicatorsGreen: false,
        startDate: DateTime.now().subtract(const Duration(days: 30)),
        ...
        enableDynamicPositionSizing: true,
        timeBasedExitEnabled: true,
        timeBasedExitMinutes: 60, // Exit after 1 hour if target not hit
      ),
      createdAt: DateTime.now(),
    ),
  ];
