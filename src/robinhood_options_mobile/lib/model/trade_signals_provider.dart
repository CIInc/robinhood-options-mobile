...
class TradeSignalsProvider with ChangeNotifier {
    ...
    switch (key) {
      case 'priceMovement':
        return {
          ...
          'technicalDetails':
              '**Multi-pattern technical analysis** detecting 7 chart patterns:\n'
              '\n'
      ...
      case 'volume':
        return {
          ...
          'technicalDetails':
              '**Formula**: `Volume Ratio = Current Volume / 20-period Avg Volume`\n'
              '\n'
              '**Signals**:\n'
      ...
      case 'atr':
        return {
          ...
          'technicalDetails':
              '**Parameters**: `14 bars` (Wilder\'s smoothing)\n'
              '\n'
              '**Formulas**:\n'
      ...
      case 'adx':
        return {
          ...
          'technicalDetails':
              '**Parameters**: `14 bars` (requires 28+ bars total)\n'
              '\n'
              '**Formulas**:\n'
  ...
  Future<Map<String, dynamic>> initiateTradeProposal({
    ...
    final payload = {
      ...
      'exitStages': config.strategyConfig.exitStages
          .map((e) => e.toJson())
          .toList(),
    ...
    try {
      final result = await _functions
          .httpsCallable('initiateTradeProposal')
          .call(payload);
      ...
      if (status == 'approved') {
        ...
        _analytics.logEvent(
          name: 'trade_signals_trade_rejected',
          parameters: {
