...
class AchTransfer {
  ...
  factory AchTransfer.fromJson(dynamic json) {
    ...
    final expectedLandingDateTime =
        parseDate(json['expected_landing_datetime']);
  ...
  factory AchSummary.fromTransfersAndRelationships(
    ...
    for (final transfer in transfers) {
      ...
      if (transfer.isCompleted) {
        ...
        if (landing != null) {
          final nextLanding = nextClearing?.expectedLandingDateTime ??
    ...
    final activeRelationships =
        relationships.where((r) => !r.isUnlinked).toList();
    final verifiedCount =
        activeRelationships.where((r) => r.isApproved && r.verified).length;
