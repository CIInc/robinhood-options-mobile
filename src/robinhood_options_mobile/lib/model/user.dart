...
class User {
  ...
  User.fromJson(Map<String, Object?> json)
    : this(
        ...
        role: (json['role'] != null ? json['role'] as String : '').parseEnum(
          UserRole.values,
          UserRole.user,
        ),
        ...
        tradeSignalNotificationSettings:
            ...
            ? TradeSignalNotificationSettings.fromJson(
                json['tradeSignalNotificationSettings'] as Map<String, dynamic>,
              )
            : null,
        ...
        assetAllocationTargets: json['assetAllocationTargets'] != null
            ? (json['assetAllocationTargets'] as Map<String, dynamic>).map(
                (key, value) => MapEntry(key, (value as num).toDouble()),
              )
            : null,
        sectorAllocationTargets: json['sectorAllocationTargets'] != null
            ? (json['sectorAllocationTargets'] as Map<String, dynamic>).map(
                (key, value) => MapEntry(key, (value as num).toDouble()),
              )
            : null,
        subscriptionStatus: json['subscriptionStatus'] as String?,
        trialStartDate: json['trialStartDate'] != null
            ? (json['trialStartDate'] as Timestamp).toDate()
            : null,
