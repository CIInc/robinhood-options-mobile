...
class TradeStrategyConfig {
  ...
  factory TradeStrategyConfig.fromJson(
    ...
    minSignalStrength: (json['minSignalStrength'] as num?)?.toDouble() ?? 50.0,
    requireAllIndicatorsGreen:
    ...
    marketCloseExitEnabled: json['marketCloseExitEnabled'] as bool? ?? false,
    marketCloseExitMinutes: json['marketCloseExitMinutes'] as int? ?? 15,
    enablePartialExits: json['enablePartialExits'] as bool? ?? false,
    exitStages:
        (json['exitStages'] as List<dynamic>?)
            ?.map(
              (e) => ExitStage.fromJson(Map<String, dynamic>.from(e as Map)),
            )
            .toList() ??
        [],
    enableDynamicPositionSizing:
    ...
    customIndicators:
        (json['customIndicators'] as List<dynamic>?)
            ?.map(
              (e) => CustomIndicatorConfig.fromJson(
        ...
        [],
    symbolFilter:
        (json['symbolFilter'] as List<dynamic>?)
            ?.map((e) => e as String)
            .toList() ??
        [],
    enableSectorLimits: json['enableSectorLimits'] as bool? ?? false,
    maxSectorExposure: (json['maxSectorExposure'] as num?)?.toDouble() ?? 0.2,
    enableCorrelationChecks: json['enableCorrelationChecks'] as bool? ?? false,
    maxCorrelation: (json['maxCorrelation'] as num?)?.toDouble() ?? 0.8,
    enableVolatilityFilters: json['enableVolatilityFilters'] as bool? ?? false,
    ...
    rsiExitThreshold: (json['rsiExitThreshold'] as num?)?.toDouble() ?? 80.0,
    signalStrengthExitEnabled:
  ...
  Map<String, String> getDifferences(TradeStrategyConfig other) {
    ...
    check(
      'Require All Indicators Green',
      other.requireAllIndicatorsGreen,
      requireAllIndicatorsGreen,
    );
    ...
    check(
      'Max Concentration',
      other.maxPortfolioConcentration,
      maxPortfolioConcentration,
    );
    ...
    check(
      'Strength Exit',
      other.signalStrengthExitEnabled,
      signalStrengthExitEnabled,
    );
    check(
      'Strength Threshold',
      other.signalStrengthExitThreshold,
      signalStrengthExitThreshold,
    );
    ...
    check(
      'Dynamic Sizing',
      other.enableDynamicPositionSizing,
      enableDynamicPositionSizing,
    );
    ...
    check(
      'Correlation Checks',
      other.enableCorrelationChecks,
      enableCorrelationChecks,
    );
    check('Max Correlation', other.maxCorrelation, maxCorrelation);
    check(
      'Volatility Filters',
      other.enableVolatilityFilters,
      enableVolatilityFilters,
    );
    ...
    check(
      'Drawdown Protection',
      other.enableDrawdownProtection,
      enableDrawdownProtection,
    );
