...
class WatchlistGridItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var optionStrategy = watchListItem.objectType == 'option_strategy'
        ? watchListItem
        : null;
                    ...
                    child: Wrap(
                      ...
                      children: [
                        ...
                        if (optionStrategy != null &&
                          ...
                          Text(
                            formatCurrency.format(optionStrategy.openPrice),
                            style: const TextStyle(
                              fontSize: 14.0,
                              fontWeight: FontWeight.bold,
                            ),
                          ...
                          if (optionStrategy.openPriceDirection != null)
                            Text(
                              optionStrategy.openPriceDirection!,
                              style: TextStyle(
                                fontSize: 12.0,
                                color: Theme.of(
                                  context,
                          ...
                          Text(
                            formatCurrency.format(
                              optionStrategy.optionInstrumentObj!.strikePrice,
                            ),
                            style: const TextStyle(
                              fontSize: 14.0,
                              fontWeight: FontWeight.bold,
          ...
          if (watchListItem.optionInstrumentObj != null) {
            ...
            if (instrument != null && context.mounted) {
              ...
              if (watchListItem.strategy != null) {
                typeFilter = watchListItem.strategy!.contains("call")
                    ? "Call"
                    : "Put";
              }
              Navigator.push(
