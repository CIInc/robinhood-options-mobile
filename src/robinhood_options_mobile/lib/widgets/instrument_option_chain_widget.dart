...
class InstrumentOptionChainWidget extends StatefulWidget {
  ...
  InstrumentOptionChainWidget(this.user, this.instrument);

  @override
  _InstrumentOptionChainWidgetState createState() =>
      _InstrumentOptionChainWidgetState(user, instrument);
}
...
class _InstrumentOptionChainWidgetState
  ...
  _InstrumentOptionChainWidgetState(this.user, this.instrument);
