...
class _HistoryPageState extends State<HistoryPage>
    ...
    for (int i = 0; i < users.length; i++) {
      ...
      final sub = stream.listen(
        (items) {
          ...
          final merged = _mergeAggregateLists(
            state.latest,
            keyOf: keyOf,
            sort: sort,
          );
  ...
  void _ensureAggregateStreams(List<BrokerageUser> users) {
    ...
    if (dividendStream == null) {
      ...
      dividendStream = _initAggregateStream<dynamic>(
        ...
        streamBuilder: (user, service) => service.streamDividends(
          user,
          instrumentStore,
          userDoc: widget.userDoc,
        ),
    ...
    if (interestStream == null) {
      ...
      interestStream = _initAggregateStream<dynamic>(
        ...
        streamBuilder: (user, service) => service.streamInterests(
          user,
          instrumentStore,
          userDoc: widget.userDoc,
        ),
  ...
  Widget _buildScaffold() {
    ...
    final aggregateUsers = isAggregateMode
        ? _aggregateUsers()
        : const <BrokerageUser>[];
    ...
    return StreamBuilder(
      ...
      builder: (context5, optionOrdersSnapshot) {
        if (optionOrdersSnapshot.hasData) {
                      ...
                      if (!isAggregateMode && optionOrders != null) {
                        for (var optionEvent in optionEvents!) {
                          ...
                          if (originalOptionOrder != null) {
                            ...
                            originalOptionOrder.optionEvents!.add(optionEvent);
                          }
                        }
                      }
                      ...
                      return StreamBuilder(
                        ...
                        builder: (context6, dividendSnapshot) {
                          if (dividendSnapshot.hasData) {
                            dividends = dividendSnapshot.data as List<dynamic>;
                            dividends!.sort(
                              (a, b) => DateTime.parse(
                                b["payable_date"],
                            ...
                            return StreamBuilder<Object>(
                              ...
                              builder: (context7, interestSnapshot) {
                                if (interestSnapshot.hasData) {
                                  interests =
                                      interestSnapshot.data as List<dynamic>;
                                  interests!.sort(
                                    (a, b) => DateTime.parse(
                                      b["pay_date"],
                            ...
                            return _buildPage(
                              ...
                              optionEvents: optionEvents,
                                  ...
                                  positionOrdersSnapshot.connectionState ==
                                      ConnectionState.done &&
                                  optionOrdersSnapshot.connectionState ==
                                      ConnectionState.done &&
                                  dividendSnapshot.connectionState ==
          ...
          // No Position Orders found.
          return _buildPage(
            done: optionOrdersSnapshot.connectionState == ConnectionState.done,
          );
        }
      },
    );
  ...
  Widget _buildPage({
    ...
    if (optionOrders != null) {
      optionOrderSymbols = optionOrders
          .map((e) => e.chainSymbol)
          .toSet()
          .toList();
      ...
      filteredDividends = dividends
          .where(
            (element) =>
                ...
                (days == 0 ||
                    DateTime.parse(
                          element["payable_date"]!,
                        ).add(Duration(days: days)).compareTo(DateTime.now()) >=
                        0) &&
                (stockSymbolFilters.isEmpty ||
                    stockSymbolFilters.contains(
                      element["instrumentObj"]!.symbol,
                    )),
          )
          .toList();
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                "$orderDateFilterDisplay ${positionOrdersBalance > 0
                                    ? "+"
                              ...
                              ListTile(
                                ...
                                onTap: showShareView
                                    ? () => _setSelection(
                                        selectedPositionOrdersToShare,
                                        order.id,
                                        !selectedPositionOrdersToShare.contains(
                                          order.id,
                                        ),
                                      )
                                    : () {
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                "$orderDateFilterDisplay ${optionOrdersPremiumBalance > 0
                                    ? "+"
                            ...
                            children: <Widget>[
                              ListTile(
                                ...
                                leading: CircleAvatar(
                                  radius: 22,
                                  backgroundColor: event.direction == 'credit'
                                      ? Colors.green.withValues(alpha: 0.1)
                                      : Colors.red.withValues(alpha: 0.1),
                                  foregroundColor: event.direction == 'credit'
                                      ? Colors.green
                                      : Colors.red,
                                  child: Text(
                                    '${event.quantity!.round()}',
                                    style: const TextStyle(
                                      fontSize: 13,
                                      fontWeight: FontWeight.bold,
                                    ),
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                "$orderDateFilterDisplay ${dividendBalance > 0
                                    ? "+"
                                    : dividendBalance < 0
                                    ? "-"
                                    : ""}${formatCurrency.format(dividendBalance.abs())}",
                                style: TextStyle(
                                  color: Theme.of(
                                    context,
                                  ).textTheme.bodySmall?.color,
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ListTile(
                                ...
                                leading: _buildSelectionLeading(
                                  selected: selectionsToShare.contains(
                                    dividend["id"],
                                  ),
                                  onChanged: (value) => _setSelection(
                                    selectionsToShare,
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                "$orderDateFilterDisplay ${interestBalance > 0
                                    ? "+"
                                    : interestBalance < 0
                                    ? "-"
                                    : ""}${formatCurrency.format(interestBalance.abs())}",
                                style: TextStyle(
                                  color: Theme.of(
                                    context,
                                  ).textTheme.bodySmall?.color,
                  ...
                  if (filteredInterests!.isEmpty)
                    ...
                    SliverList(
                      ...
                      delegate: SliverChildBuilderDelegate((
                        ...
                        var interestAmount = double.parse(
    ...
    return TimeSeriesChart(
      [
        charts.Series<dynamic, DateTime>(
          ...
          labelAccessorFn: (datum, index) => formatCompactNumber.format(
      ...
      primaryMeasureAxis: charts.NumericAxisSpec(
        ...
        viewport: charts.NumericExtents.fromValues(
          groupedDividendsData.map((e) => e.value),
  ...
  Widget interestChart() {
    ...
    return TimeSeriesChart(
      ...
      primaryMeasureAxis: charts.NumericAxisSpec(
        ...
        //renderSpec: charts.GridlineRendererSpec(),
        viewport: charts.NumericExtents.fromValues(
          groupedInterestsData.map((e) => e.value),
        ), //.NumericExtents(0, 500),
        renderSpec: charts.SmallTickRendererSpec(
          labelStyle: charts.TextStyleSpec(color: axisLabelColor),
        ),
  ...
  */
  ...
  Widget symbolWidgets(List<Widget> widgets, {int rowCount = 3}) {
    ...
    var lists = List.generate(
      ...
      (i) => widgets.sublist(
        m * i,
        (i + 1) * m <= widgets.length ? (i + 1) * m : null,
      ),
    );
  ...
  Widget buildOptionOrderSymbolFilterWidget(
    int rowCount, [
  ...
  Widget buildStockOrderSymbolFilterWidget(
    int rowCount, [
    StateSetter? bottomSheetSetState,
  ]) {
    var widgets = symbolFilterWidgets(
  ...
  Widget buildCryptoFilterWidget(
    int rowCount, [
    StateSetter? bottomSheetSetState,
  ]) {
    var widgets = symbolFilterWidgets(
  ...
  void _setSelection(List<String> selections, String id, bool? selected) {
    setState(() {
      if (selected ?? false) {
  ...
  Future<void> _showShareView() async {
    if (showShareView) {
      var optionOrdersToShare = optionOrders!.where(
        (element) => selectedOptionOrdersToShare.contains(element.id),
      );
      var positionOrdersToShare = positionOrders!.where(
        (element) => selectedPositionOrdersToShare.contains(element.id),
      );

      var optionOrdersTexts = optionOrdersToShare.map(
        (e) =>
