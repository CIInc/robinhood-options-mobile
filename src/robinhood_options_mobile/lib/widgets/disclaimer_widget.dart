  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: const Align(
            ...
            child: Text(
                "Investing Mobile is not a registered investment, legal or tax advisor or a broker/dealer. All investment/financial opinions expressed by Investing Mobile are intended  as educational material.")));
