  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: const Align(
            ...
            child: Text(
                "Investiomanus is not a registered investment, legal or tax advisor or a broker/dealer. All investment/financial opinions expressed by Investiomanus are intended  as educational material.")));
