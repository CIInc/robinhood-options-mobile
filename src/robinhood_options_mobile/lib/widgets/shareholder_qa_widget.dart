...
class _ShareholderQaWidgetState extends State<ShareholderQaWidget> {
    ...
    setState(() {
      _futureQaSection = widget.service
          .getShareholderQaSectionModel(
              widget.brokerageUser, effectiveInstrumentId,
  ...
  Future<void> _handleVote(
      ShareholderQaEvent event, ShareholderQuestion question) async {
  ...
  void _showSubmitQuestionSheet(
      BuildContext context, ShareholderQaEvent event) {
                      ...
                      Row(
                        children: [
                          Icon(Icons.how_to_vote,
                              color: Theme.of(sheetInnerContext)
                                  .colorScheme
                                  .primary,
                              size: 24),
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 8),
          _buildFilterChip(
              'Most Votes', 'most_votes', Icons.thumb_up_alt_outlined),
          const SizedBox(width: 8),
          _buildFilterChip(
  ...
  List<Widget> _buildQuestionsList(ShareholderQaEvent event) {
    ...
    if (_filterType == 'most_votes') {
      ...
      questions
          .sort((a, b) => b.sharesRepresented.compareTo(a.sharesRepresented));
    }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ShareholderQaSection?>(
      ...
      builder: (context, snapshot) {
        ...
        final topQuestion =
            event.questions.isNotEmpty ? event.questions.first : null;
