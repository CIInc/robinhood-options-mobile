...
class _OptionInstrumentWidgetState extends State<OptionInstrumentWidget> {
                ...
                if (instrumentSnapshot.hasData) {
                      ...
                      if (ordersSnapshot.hasData) {
                        return _buildPage(
                          ...
                          optionOrders: ordersSnapshot.data!,
                              ...
                              instrumentSnapshot.connectionState ==
                  ...
                  return _buildPage(
                    widget.optionInstrument,
                        ...
                        instrumentSnapshot.connectionState ==
                            ConnectionState.done &&
                        quoteSnapshot.connectionState == ConnectionState.done,
                  );
                }
              },
            );
  ...
  Widget _buildPage(
    ...
    if (optionInstrument.createdAt != null) {
      DateTime createdAt = DateTime(
        optionInstrument.createdAt!.year,
        optionInstrument.createdAt!.month,
        optionInstrument.createdAt!.day,
      );
      if (optionPosition != null) {
        createdAt = DateTime(
          optionPosition.createdAt!.year,
          optionPosition.createdAt!.month,
          optionPosition.createdAt!.day,
        );
      }
      originalDte = optionInstrument.expirationDate!
                ...
                return Wrap(
                  ...
                  children: [
                    ...
                    _buildStatCard(
                      ...
                      textColor: dte < 5 && !dte.isNegative ? Colors.red : null,
                      width: width,
                    ),
                    if (!isLong)
                      _buildStatCard(
    ...
    return Card(
      child: Column(
        ...
        children: <Widget>[
              ...
              children: [
                Column(
                  children: [
                    ...
                    Text(
                      formatCurrency.format(data.bidPrice),
                      style: const TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                      ),
                ...
                Column(
                  children: [
                    ...
                    Text(
                      formatCurrency.format(data.adjustedMarkPrice),
                      style: const TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                      ),
                ...
                Column(
                  children: [
                    ...
                    Text(
                      formatCurrency.format(data.askPrice),
                      style: const TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                      ),
                        ...
                        children: [
                          ...
                          Container(
                            margin: EdgeInsets.only(
                              left: (constraints.maxWidth * percent).clamp(
                                0,
          ...
          _buildDetailRow(
            "Previous Close",
            formatCurrency.format(data.previousClosePrice),
          ),
        ],
      ),
    );
    ...
    if (large) {
      return Column(
        ...
        children: [
          ...
          Text(
            formatPercentage.format(percent),
            style: TextStyle(
              fontSize: 16,
        ...
        if (optionInstrumentHistoricalsObj != null) {
          ...
          TimeSeriesChart historicalChart = TimeSeriesChart(
            ...
            close: optionInstrumentHistoricalsObj
                .historicals[optionInstrumentHistoricalsObj.historicals.length -
                    1]
                .closePrice!,
                                ...
                                children: [
                                  ...
                                  Text(
                                    "${changeInPeriod > 0
                                        ...
                                        : changeInPeriod < 0
                                        ? "-"
                                        : ""}${formatCurrency.format(changeInPeriod.abs())}",
                                    style: TextStyle(
                                      fontSize: 20.0,
                                      color: textColor,
                                    ),
                    ...
                    content: const SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("Rho (p): Sensitivity to the interest rate."),
                        ],
                      ),
                    ),
                    actions: <Widget>[
    ...
    return SliverLayoutBuilder(
      builder: (BuildContext context, constraints) {
        ...
        var optionInstrument =
            optionInstrumentStore.items.firstWhereOrNull(
                ...
                children: [
                  Wrap(
                    ...
                    children: [
                      ...
                      Text(
                        optionInstrument.type.toUpperCase(),
                        style: const TextStyle(fontSize: 16.0),
                      ),
                      Text(
                      ...
                      children: [
                        ...
                        Text(
                          "${optionInstrument.optionMarketData!.changeToday > 0
                              ...
                              : optionInstrument.optionMarketData!.changeToday < 0
                              ? "-"
                              : ""}${formatCurrency.format(optionInstrument.optionMarketData!.changeToday.abs())}",
                          style: const TextStyle(fontSize: 14.0),
                          textAlign: TextAlign.right,
                        ),
                      ],
  ...
  List<Widget> _buildLegs(OptionAggregatePosition optionPosition) {
    ...
    for (int i = 0; i < optionPosition.legs.length; i++) {
      ...
      widgets.add(
        _buildDetailRow("Strike Price", formatCurrency.format(leg.strikePrice)),
      );
        ...
        Card(
          ...
          child: InkWell(
            ...
            child: Padding(
              ...
              child: ListTile(
                title: Text(
                  instrument.simpleName ?? instrument.symbol,
                  style: const TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                  ),
                      ...
                      MaterialPageRoute(
                        builder: (context) => InstrumentOptionChainWidget(
                          ...
                          initialExpirationDate:
                              optionInstrument.expirationDate,
                          initialTypeFilter: optionInstrument.type == 'call'
                              ? 'Call'
                              : 'Put',
                ...
                Expanded(
                  child: FilledButton.icon(
                    ...
                    label: FittedBox(
                      fit: BoxFit.scaleDown,
                      child: Text(
                        optionPosition.direction == "debit"
                            ? "Buy"
                            : "Buy to Close",
                      ),
                    ),
