...
void main() {
  group('InstrumentTradeWarningsBanner Widget Tests', () {
    ...
    testWidgets(
      'renders warning banner with title, message, and tap callback',
      (WidgetTester tester) async {
        ...
        expect(
          find.text('Extreme swings detected in this symbol.'),
          findsOneWidget,
        );
    ...
    testWidgets(
      'renders critical error banner when halted or critical warning',
      (WidgetTester tester) async {
        const warning = InstrumentTradeWarning(
          id: 'w_crit',
          type: 'halt',
  ...
  group('InstrumentBuyingPowerSummaryTile Widget Tests', () {
    testWidgets(
      'renders buying power, margin status chip, and currency format',
      (WidgetTester tester) async {
        bool tapped = false;
