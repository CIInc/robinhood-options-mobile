...
void main() {
  group('AgenticTradingConfig Tests', () {
    test(
      'AgenticTradingConfig should serialize and deserialize all fields',
      () {
        ...
        expect(
          json['strategyConfig']['maxPortfolioConcentration'],
          equals(0.3),
        );
        ...
        expect(
          json['strategyConfig']['enableDynamicPositionSizing'],
          equals(true),
        );
        ...
        expect(
          json['strategyConfig']['enabledIndicators']['priceMovement'],
          equals(true),
        );
        expect(
          json['strategyConfig']['enabledIndicators']['momentum'],
          equals(false),
        );
        ...
        expect(
          json['strategyConfig']['enableDrawdownProtection'],
          equals(true),
        );
        ...
        expect(
          json['strategyConfig']['signalStrengthExitEnabled'],
          equals(true),
        );
        expect(
          json['strategyConfig']['signalStrengthExitThreshold'],
          equals(45.0),
        );
        ...
        expect(
          deserializedConfig.strategyConfig.maxPortfolioConcentration,
          equals(0.3),
        );
        expect(
          deserializedConfig.strategyConfig.enableDynamicPositionSizing,
          equals(true),
        );
        ...
        expect(
          deserializedConfig.strategyConfig.marketIndexSymbol,
          equals('QQQ'),
        );
        ...
        expect(
          deserializedConfig.strategyConfig.takeProfitPercent,
          equals(15.0),
        );
        ...
        expect(
          deserializedConfig.strategyConfig.enabledIndicators['momentum'],
          equals(false),
        );
        expect(
          deserializedConfig.strategyConfig.enableSectorLimits,
          equals(true),
        );
        expect(
          deserializedConfig.strategyConfig.maxSectorExposure,
          equals(0.15),
        );
        expect(
          deserializedConfig.strategyConfig.enableCorrelationChecks,
          equals(true),
        );
        expect(deserializedConfig.strategyConfig.maxCorrelation, equals(0.75));
        expect(
          deserializedConfig.strategyConfig.enableVolatilityFilters,
          equals(true),
        );
        ...
        expect(
          deserializedConfig.strategyConfig.enableDrawdownProtection,
          equals(true),
        );
        ...
        expect(
          deserializedConfig.strategyConfig.rsiExitThreshold,
          equals(85.0),
        );
        expect(
          deserializedConfig.strategyConfig.signalStrengthExitEnabled,
          equals(true),
        );
        expect(
          deserializedConfig.strategyConfig.signalStrengthExitThreshold,
          equals(45.0),
        );
      },
    );
    ...
    test('AgenticTradingConfig should have correct default values', () {
      ...
      expect(
        config.strategyConfig.enabledIndicators['priceMovement'],
        equals(false),
      );
      expect(
        config.strategyConfig.enabledIndicators['momentum'],
        equals(false),
      );
      expect(
        config.strategyConfig.enabledIndicators['marketDirection'],
        equals(false),
      );
      ...
      expect(
        config.strategyConfig.enabledIndicators['bollingerBands'],
        equals(false),
      );
      expect(
        config.strategyConfig.enabledIndicators['stochastic'],
        equals(false),
      );
    ...
    test('AgenticTradingConfig copyWith should work correctly', () {
      final original = AgenticTradingConfig(
        strategyConfig: TradeStrategyConfig(dailyTradeLimit: 5),
      ...
      expect(
        updated.strategyConfig.smaPeriodFast,
        equals(original.strategyConfig.smaPeriodFast),
      );
      expect(
        updated.autoTradeCooldownMinutes,
        equals(original.autoTradeCooldownMinutes),
      );
    });

    test(
      'AgenticTradingConfig should validate risk management constraints',
      () {
