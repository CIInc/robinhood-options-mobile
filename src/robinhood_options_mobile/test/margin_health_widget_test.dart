...
void main() {
  testWidgets(
    ...
    expect(
        find.text('Understanding Margin Health & FINRA Rules'), findsOneWidget);
  });
  ...
  testWidgets(
    ...
    expect(find.text('\$17,617.02'), findsOneWidget); // Maintenance requirement
    expect(find.text('\$55,684.81'), findsOneWidget); // Portfolio equity
    expect(find.text('\$49,807.62'),
        findsOneWidget); // Borrowing limit (total_margin)
  });
}
