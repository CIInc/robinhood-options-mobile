  ...
  group('User Model Investment Profile Tests', () {
    test(
      ...
      () {
        ...
        expect(
          investmentProfile['investmentGoals'],
          equals('Retirement planning and wealth building'),
        );
        expect(
          investmentProfile['timeHorizon'],
        ...
        expect(
          deserializedUser.investmentProfile!.investmentGoals,
          equals('Retirement planning and wealth building'),
        );
        expect(
          deserializedUser.investmentProfile!.timeHorizon,
          equals('Long-term (5-10 years)'),
        );
        expect(
          deserializedUser.investmentProfile!.riskTolerance,
          equals('Moderate'),
        );
        expect(
          deserializedUser.investmentProfile!.totalPortfolioValue,
          equals(100000.00),
        );
      },
    );
    ...
    test(
      'User model should handle missing investment profile fields in JSON',
      () {
        final now = DateTime.now();
