...
void main() {
  group('InstrumentCostBasisLookbackSummary FIFO Calculation Tests', () {
    ...
    test(
        'filterCycles correctly filters closed cycles and recalculates metrics',
        () {
      ...
      final orders = [
        _createOrder(
            id: 'o1', side: 'buy', quantity: 10, price: 100, createdAt: d1),
        _createOrder(
            id: 'o2', side: 'sell', quantity: 10, price: 130, createdAt: d2),
        _createOrder(
            id: 'o3', side: 'buy', quantity: 20, price: 50, createdAt: d3),
        _createOrder(
            id: 'o4', side: 'sell', quantity: 20, price: 40, createdAt: d4),
      ];

      final summary =
          InstrumentCostBasisLookbackSummary.fromOrders(orders, symbol: 'XYZ');
      expect(summary.totalRoundTrips, 2);
      ...
      final emptyFiltered =
          summary.filterCycles((c) => c.closedAt!.year == 2020);
    ...
    test('aggregate combines multiple ticker summaries into portfolio summary',
      ...
      final s1 = InstrumentCostBasisLookbackSummary.fromOrders([
        _createOrder(
            id: 'a1', side: 'buy', quantity: 10, price: 100, createdAt: d1),
        _createOrder(
            id: 'a2', side: 'sell', quantity: 10, price: 120, createdAt: d2),
      ], symbol: 'AAPL'); // +200

      final s2 = InstrumentCostBasisLookbackSummary.fromOrders([
        _createOrder(
            id: 't1', side: 'buy', quantity: 5, price: 200, createdAt: d1),
        _createOrder(
            id: 't2', side: 'sell', quantity: 5, price: 250, createdAt: d2),
      ], symbol: 'TSLA'); // +250
