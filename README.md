...
*   **AI-Powered Insights:** Leverages Generative AI (upgraded to **Gemini 2.5 Flash Lite** for improved performance) to provide analysis on market data (e.g., chart trends) with personalized investment profile integration.
