...
*   **Historical Data Analysis:** Fetches and visualizes historical price data for instruments. **New:** Benchmark Chart with Date Range Selection (1W, 1M, 3M, YTD, 1Y, ALL) for performance comparison. Supports major indices including S&P 500, Nasdaq 100, Dow Jones, and Russell 2000 (IWM).*   **(New) Market Intelligence:**
    *   **Whale Watch Tracker:** Track institutional accumulation and large transactions (Whales) with data aggregation and dashboard visualization.
    ...
    *   **[Gamma Exposure (GEX) Analysis](docs/gamma-exposure-analysis.md):** Market maker positioning tracker featuring custom interactive coordinate metrics charts, Call Wall and Put Wall boundary plots, ranked high-liquidity ticker leaderboards, and a real-time on-device mathematical Black-Scholes Option Gamma fallback engine in Dart.
