...
*   **[Schwab Integration](docs/schwab-integration.md):** OAuth account linking, portfolio and order history, stock and option order placement, multi-leg option order support, and robust API response parsing for quotes, option chains, price history, and execution status.
