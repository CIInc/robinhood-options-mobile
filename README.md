...
*   **v0.53.0 Highlights:** [Congressional STOCK Act disclosure tracking](docs/congress-trading-tracker.md) with portfolio-overlap alerts; [SEC EDGAR research](docs/sec-edgar-integration.md) for 13F, Form 4, and 8-K filings; expanded earnings, dividend, news, unusual-activity, and options-expiration alerts; and Schwab historical account activity.
...
*   **Market Intelligence:**
    ...
    *   **[SEC EDGAR Disclosures](docs/sec-edgar-integration.md):** Research 13F institutional holdings, Form 4 insider transactions, and 8-K material events with portfolio-overlap context.
    *   **[Congress & Political Trading Tracker](docs/congress-trading-tracker.md):** Review House and Senate STOCK Act filings, filing delays, and disclosed trades overlapping held stocks or options.
