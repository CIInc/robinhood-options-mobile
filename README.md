...
*   **Privacy & Navigation:** **Balance Visibility Toggle** to mask sensitive P&L and equity data in public settings. **Scroll-to-Top** navigation across all major list views for streamlined browsing.
...
- Determine the next version (e.g., `0.37.0`) based on commit impact (Features vs. Bug Fixes).
