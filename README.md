...
*   **[RiskGuard](docs/risk-guard.md):** Advanced risk validation for manual and automated trading. Enforces portfolio safety rules (concentration, sector limits) with warning dialogs and override capabilities for manual trades.
