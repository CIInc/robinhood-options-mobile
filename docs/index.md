...
- **Robinhood Market Intelligence:** The instrument view combines [short float and borrow availability](short-interest.md), [retail order flow](retail-order-flow.md), [insider activity](insider-activity.md), [institutional ownership](hedge-fund-tracking.md), and [SEC EDGAR disclosures](sec-edgar-integration.md) as separate research cards so each signal retains its source and context.
