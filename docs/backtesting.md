...
### Visual Results
- **Visual Charts**:
  - Interactive Equity Curve with clickable trade markers
  - Drawdown Chart (new)
...
- **Advanced Filtering**:
  ...
  - **Dynamic Results:** Use the new filtering interface to narrow down performance during specific market regimes.
