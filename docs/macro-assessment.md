...
### Macro Widget
The **Macro Market State** card provides an at-a-glance view of the current status, score, and individual indicator signals (VIX, TNX, Trend).
